  ...
  return (
    ...
    >
      ...
      >
        ...
        <br />
        <br />
        My core stack includes React Native with TypeScript, Kotlin, Flutter, Firebase, CI/CD pipelines with GitHub Actions, Codemagic and NestJS with TypeScript for backend. I have hands-on experience with secure mobile development practices, modern architecture patterns like MVVM and Clean Architecture, and backend development using NestJS to create robust RESTful and GraphQL APIs.
        <br />
        <br />
        I’m skilled across the full stack, particularly in React Native, Kotlin, Flutter, Firebase, and clean architecture, and I pride myself on efficient workflows with
