  ...
  return (
    ...
    >
      ...
      >
        ...
        <br />
        <br />
        I’m skilled across the full stack, particularly in Kotlin for android development, Flutter, Firebase, and clean architecture, and I pride myself on efficient workflows with
