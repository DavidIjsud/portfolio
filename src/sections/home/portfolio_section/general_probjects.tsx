...
export default function GeneralProjects({
  ...
  return (
    ...
    >
      ...
      {(categorySelected === "All" || categorySelected === "Mobile") && (
        <FirstGeneralRow onOpenDialog={handleOpenDialog} />
      )}
      {(categorySelected === "All" || categorySelected === "Mobile") && (
        <SecondGeneralRow onOpenDialog={handleOpenDialog} />
      )}

      {(categorySelected === "All" || categorySelected === "Web") && (
        <ThirdGeneralRow onOpenDialog={handleOpenDialog} />
      )}
    </Box>
  );
}
